	...
	// short by price
	 $(document).ready(function(){
	 	$(".price-btn").click(function(){
	 		var min = $(".min").val();
	 		var max = $(".max").val();
	 		window.location = "http://localhost/bookstore/shop/pages/php/price.php?max="+max+"&&min="+min;
	 ...
	 $(document).ready(function(){
	 	$(".city-btn").click(function(){
	 		var city = $(".city").val();
			window.location = "http://localhost/bookstore/shop/pages/php/city.php?city="+city;
	 	});
	 });
