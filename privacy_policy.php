...
<head>
	...
	<link rel="stylesheet" href="common_files/css/slick-theme.css">
	<link rel="stylesheet" href="common_files/css/slick.css">
	...
	<script src="common_files/js/jquery-1.9.1.min.js"></script>
	<script src="common_files/js/slick.js"></script>
...
Please be informed that the information you supply while making a payment for an availed service is processed through a secure payment gateway and that we do not store such information, including your bank account details, in our server.</p>
...
<h5>Information correction</h5>
<p>
To update or correct your personally identifiable information that we hold, you can notify us at contact@shopwap.com
</p>
...
<p>
In the unlikely event of a breach in security systems, we may notify you through email so that you can take suitable protective measures. You are advised to inform us immediately at contact@shopwap.com in case your user name or password is compromised.
</p>
</div>
